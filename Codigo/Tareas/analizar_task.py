...
analizar_tareas = Task(
    name='analizar_tareas',
    description="""
                Analizar la lista de tareas académicas proporcionadas por el estudiante con los siguientes datos:

                Nombre: {nombre}
                Horas diarias disponibles: {horas_diarias}
                Tareas: {tareas}
                ...
                para evitar riesgos de retraso.

                Especificar claramente cuánta holgura se ha asignado a cada tarea y justificarla cuando sea necesario.

                Elaborar un informe claro y estructurado que priorice las tareas y prepare la información
